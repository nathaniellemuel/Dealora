        ...
        <div className="w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl shadow-black/50">
            ...
            <div className="border-t border-zinc-800 px-5 py-4">
                ...
                <div className="mt-4 flex items-center justify-between font-mono text-xs">
                    ...
                    <a href="#" className="font-medium text-emerald-300 transition-colors hover:text-emerald-200">
                        Verify record
                    </a>
                </div>
            </div>
                ...
                <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr]">
                    <div>
                        ...
                        <p className="mt-5 max-w-xl text-lg leading-relaxed text-zinc-400">
                            Dealora turns freelance project chats into a structured scope of work and stores its
                            fingerprint on-chain, so both sides can check the original terms later.
                        </p>
